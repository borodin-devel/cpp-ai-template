...
description: >
  ...
  and stale path cleanup. Use when behavior, commands, layout, targets, or agent guidance changes.
---
...
Do not run formatting, lint, sanitize, or clean scripts unless documentation work requires validating a command example.
