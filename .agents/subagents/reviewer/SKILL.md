...
4. `.agents/utilities/cmake.md` when CMake, dependencies, tests, or validation changed
...
4. Check changed tests for meaningful coverage.
5. Check CMake changes against `.agents/utilities/cmake.md`.
6. Check dependency changes against `cmake/Dependencies.cmake` and `cmake/GoogleTest.cmake`.
...
- `Critical`: breaks builds, corrupts data, creates serious security or safety risk, or invalidates core workflow.
...
- Build, dependency, preset, warning, sanitizer, or script findings.
